...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lbl_show1->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        lbl_show2->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
